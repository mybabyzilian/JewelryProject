...
public class MineFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected void initView(View view) {
        ...
        view.findViewById(R.id.mine_my_material).setOnClickListener(this);//我的资料
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.my_issue_rl:
                ...
                intent_issue.putExtra("title","我的发布");
            ...
            case R.id.my_collection_rl:
                ...
                intent_collection.putExtra("title","我的收藏");
            ...
            case R.id.my_participate_rl:
                ...
                intent_participate.putExtra("title","我的参与");
            ...
            case R.id.mine_my_material:
                Intent intent = new Intent(MyApp.getContext(), MyMaterialActivity.class);

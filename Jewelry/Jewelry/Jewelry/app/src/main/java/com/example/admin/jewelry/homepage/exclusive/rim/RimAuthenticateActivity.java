 ...
 * 首页——搜周边——周边鉴定
 */
public class RimAuthenticateActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(RimAuthenticateActivity.this, JewelryMapActivity.class);
